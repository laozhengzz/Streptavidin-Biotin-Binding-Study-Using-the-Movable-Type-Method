...
clear all
load vdw_all_AF_contact_list
for i = 2:size(vdw_all_AF_contact_list,1)
    torsion_name1 = vdw_all_AF_contact_list{i,1};
    ...
    torsion_name1 = vdw_all_AF_contact_list{i,2};
    ...
    torsion_name1 = vdw_all_AF_contact_list{i,3};
    ...
    torsion_name1 = vdw_all_AF_contact_list{i,4};
    ...
    vdw_all_AF_contact_list_num(i,1) = str2num(torsion_name_num1);
    vdw_all_AF_contact_list_num(i,2) = torsion_res_num1;
    vdw_all_AF_contact_list_num(i,3) = str2num(torsion_name_num2);
    vdw_all_AF_contact_list_num(i,4) = torsion_res_num2;
