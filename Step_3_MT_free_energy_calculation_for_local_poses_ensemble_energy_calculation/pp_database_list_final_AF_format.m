%function protein_list_num = pp_database_list_final_AF_format(protein_Namelist)

clear all
load pp_nonbonding_Contact_list
for i = 1:size(pp_nonbonding_Contact_list,1)
    torsion_name1 = pp_nonbonding_Contact_list{i,1};
    ...
    torsion_name1 = pp_nonbonding_Contact_list{i,2};
    ...
    torsion_name1 = pp_nonbonding_Contact_list{i,3};
    ...
    torsion_name1 = pp_nonbonding_Contact_list{i,4};
    ...
    pp_nonbonding_Contact_list_num(i,1) = str2num(torsion_name_num1);
    pp_nonbonding_Contact_list_num(i,2) = torsion_res_num1;
    pp_nonbonding_Contact_list_num(i,3) = str2num(torsion_name_num2);
    pp_nonbonding_Contact_list_num(i,4) = torsion_res_num2;
