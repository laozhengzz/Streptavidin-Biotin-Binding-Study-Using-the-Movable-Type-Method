function [protein,protein_list_num,protein_sol] = protein_define_final_sol(protein_dir)
...
protein_sol = protein_type_convert(protein_atom,AtomName,resName,protein_resseq);
