function  out1 = check_pocket_before(i,dummy,k,l,y1)

i_now=i; dummy_now=dummy; l_now=l; k_now = k; y1_now=y1;

load chk.mat;
if exist('chkpoint.mat') == 2
    load chkpoint.mat;
else num1=1; drum11=zeros(3,3);
end

dist_h=2.3; dist_nb=2.8;
i=i_now; dummy=dummy_now; l=l_now; k=k_now; y1 = y1_now;
clear i_now drume_now k_now l_now y1_now k_now;
